...
\section{Densification and diffusion in firn and ice}
...
\subsection{Electrical conductivity measurements}
...
\subsection{Dielectric Profiling}
...
A third way of analyzing ice cores and thus laying the basis for paleo climate research is through measurements of the isotopic composition of the water which makes up the ice cores. Water isotopes are sensitive to temperature changes and can thus be used as a proxy for paleo temperature along with being used as dating parameters, since the annual cycles often are detectable in water isotope data.
...
\textbf{Fractionation}\\
\subsubsection{Measuring water isotopes}
\textbf{Cavity Ring-Down Spectroscopy}\\
\textit{Calibration}\\
\textbf{Spectral Analysis}\\
\textit{Power Spectral Densities (PSD)}\\
\textit{Maximum Entropy Method}\\
\textit{Noise of PSD and variance of depth series}\\
