...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption{Illustration of the general idea, restoring signal by tuning the diffusion length until the expected number of years is detectable in the depth interval.}
