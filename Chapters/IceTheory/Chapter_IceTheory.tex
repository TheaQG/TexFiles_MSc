...
The analytical equations have been used for creating a contour plot of the analytical solutions for $\sigma_{18}$ at the close-off density, $\rho_{\text{CO}}$. \todo{Create contour plot as in Gkinis2021}
