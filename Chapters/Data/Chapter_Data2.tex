...
\begin{figure}[h]
	...
	\begin{subfigure}{.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{TambDepth_corr.png}
	...
	\begin{subfigure}{.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{LakiDepth_corr.png}
...
\begin{marginfigure}
	\centering
	\includegraphics[width=\marginparwidth]{SiteATambDepth_Gauss.png}
...
\begin{marginfigure}
	\centering
	\includegraphics[width=\marginparwidth]{SiteALakiDepth_Gauss.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{AllAlphabetCores.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth]{AllAlphabetCores_LT.png}
...
Example of one cores specification is presented in table \ref{Tab:SiteA_CoreSpecs}\todo{Make references to where values in table are from}. The specifications for the remaining cores can be seen in Appendix \ref{App:CoreSpecs}. \todo{DATA-ALPHABET-SPECS: Put rest of specifications in appendix.}
